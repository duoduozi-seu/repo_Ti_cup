    ...
    switch (DL_Interrupt_getPendingGroup(DL_INTERRUPT_GROUP_1)) {
        ...
        case GPIO_MULTIPLE_GPIOB_INT_IIDX:
            switch (DL_GPIO_getPendingInterrupt(GPIOB))
            {
                ...
                // case GPIO_ENCODER_PIN_ENCODER2A_IIDX:
                ...
                //     // 更新计数器
                //     right_motor.encoder.total_count += (right_motor.encoder.direction) ? -1 : 1;
                //     break;
                default:
                    break;
            }
        ...
        // case GPIO_ENCODER_PIN_ENCODER1A_IIDX:
        //     left_motor.encoder.direction = DL_GPIO_readPins(
        //         GPIO_ENCODER_PIN_ENCODER1B_PORT, 
        //         GPIO_ENCODER_PIN_ENCODER1B_PIN
        //     );
        //     if(left_motor.encoder.direction){left_motor.encoder.total_count --;}
        //     else{left_motor.encoder.total_count ++;}
